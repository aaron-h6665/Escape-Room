...
{
    public const string BuildVersion = "2026.09.20-polish-v4";
    public const string LevelVersion = "three-rooms-polish-v4";
    public const string ConfigurationId = "simon-caesar-dynamic-v4";
